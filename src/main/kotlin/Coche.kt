...
class Coche(var color: String, val marca: String, val modelo: String, val caballos: Int, val puertas: Int, matricula: String){

    var matricula = matricula
        set(value) {
            try {
                if (value.length != 7)
                    println("La matricula debe contener 7 caracteres.")
            }
    ...
    init {
        require(marca.isNotBlank() && modelo.isNotBlank()){"La marca y el modelo deben existir."}
        require(puertas in 3..5){"El modelo debe existir."}
